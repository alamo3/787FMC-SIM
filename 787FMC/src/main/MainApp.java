...
public static PropertiesChecker panelSelector;
...
public static Map<String,Sids> sidsDep=new LinkedHashMap<>();
...
public static List<String> rteEntries=new ArrayList<>();
public String [][] rteEntry = new String[2][5];
public static Multimap<String,Waypoints> wpts= LinkedListMultimap.create(); 
public static Multimap<String, Navaid> navaids = LinkedListMultimap.create();
public static Map<Integer,Waypoints> wptRTE=new LinkedHashMap<>();   
public static  HashMap<Integer,String[][]> rtePagesStore=new HashMap<>();
...
String starSelectedArr="";
public String runwaySelected;
public static String TransSelected;
String cacheAirportDep="";
public static String sidSelected;
String arrivalApprDep="";
...
int legsDisplay=0;
public static int rtePages=1;
int duplicateDisp=0;
public static int numWpt=0;
public static int activeRtePage=1;
int key=0;
...
////////////////////////////////////END OF VARIABLES LISTED 
   ...
   getATS();
    ...
    private void initComponents() {
        ...
        jLabel49.setBounds(90, 130, 250, 20);
        ...
        jLabel51.setBounds(90, 70, 230, 20);
        ...
        jLabel54.setBounds(90, 180, 240, 20);
        ...
        jLabel55.setBounds(90, 230, 260, 20);
        ...
        jLabel58.setBounds(90, 280, 270, 20);
        ...
        jLabel62.setBounds(150, 90, 290, 30);
        ...
        jLabel64.setBounds(150, 150, 290, 30);
        ...
        jLabel66.setBounds(170, 200, 270, 30);
        ...
        jLabel68.setBounds(170, 250, 270, 30);
        ...
        jLabel70.setBounds(170, 300, 270, 30);
    ...
    if(text!=null||text!=""){
        ...
        switch(button){
         ...
         if(state.equals("perfinit")){panelSelector.writeProperty("groundweight", text);jTextField1.setText("");}
          ...
          if(starSelectedDep==null){
           ...
           displayStarsandRunways();
            ...
            if(state.equals("transSelectDepStar")==false){
           starSelectedDep=null;
           displayStarsandRunways();
            }
          }
          ...
          if(starSelectedArr==null){
           ...
           displayStarsandRunways();
             ...
             if(state.equals("transSelectDepStar")){
               
               if(arrivalTransDep==null||arrivalTransDep.equals("")){
               arrivalTransDep=jLabel50.getText();
               }else{
                arrivalTransDep=""; 
               }
               displayStarsandRunways();
          ...
          if(starSelectedArr==null){
           ...
           displayStarsandRunways();
            ...
            if(state.equals("transSelectDArrStar")){
           starSelectedArr=null;
           displayStarsandRunways();
            }
          }
         ...
         if(panelSelector.retrieveProperty("column2").equals("selectTransApprDep")){
              if(arrivalApprDep!=null||arrivalApprDep.equals("")==false){
             arrivalApprDep="";
             done=true;
             displayApproaches();
              }
         ...
         if(panelSelector.retrieveProperty("column2").equals("selectTransApprArr")){
              if(arrivalApproachArr!=null||arrivalApproachArr.equals("")==false){
             arrivalApproachArr="";
             done=true;
             displayApproaches();
              }
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectApprDep")){
              if(done==false){
              if(arrivalApprDep==null||arrivalApprDep.equals("")){
                arrivalApprDep=jLabel62.getText();
                displayApproaches();
              }else if(arrivalApprDep!=null||arrivalApprDep.equals("")==false){
                arrivalApprTransDep="";
               arrivalApprDep="";
               displayApproaches();
              }
             ...
             if(panelSelector.retrieveProperty("column2").equals("selectApprArr")){
              ...
              if(arrivalApproachArr==null||arrivalApproachArr.equals("")){
                arrivalApproachArr=jLabel62.getText();
                displayApproaches();
              }else if(arrivalApproachArr!=null||arrivalApproachArr.equals("")==false){
                arrivalApprTransArr="";
               arrivalApproachArr="";
               displayApproaches();
              }
          ...
          if(state.equals("rte")){
             ...
             if(airportCachedOnceArr==false){
                cacheAirportDep=panelSelector.retrieveProperty("dest");
                 airportCachedOnceArr=true;
                 getDataStarsArr();
                 
             } 
               if(airportCachedOnceArr==true){
               if(cacheAirportArrival.equals(panelSelector.retrieveProperty("dest"))==false){
                 cacheAirportArrival=panelSelector.retrieveProperty("dest");
                 if(rawStarsArr!=null||rawStarsArr.isEmpty()==false){
                 rawStarsArr.clear();
                 }
                 if(starsTransition!=null||starsTransition.isEmpty()==false){
                 starsTransition.clear();
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectTransApprDep")){
              if(arrivalApprTransDep==null||arrivalApprTransDep.equals("")){
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectApprDep")){    //
              if(arrivalApprDep.equals("")||arrivalApprDep==null){
               arrivalApprDep=jLabel64.getText();
              }else{
//               arrivalApprTransDep=jLabel64.getText();
              }
               displayApproaches();
             ...
             if(panelSelector.retrieveProperty("column2").equals("selectTransApprArr")){
              if(arrivalApprTransArr==null||arrivalApprTransArr.equals("")){
             arrivalApprTransArr=jLabel64.getText(); 
              }else{
               arrivalApprTransArr=""; 
              }
              displayApproaches();
...
//               arrivalApprTransDep=jLabel64.getText();
          ...
          if(temp1[1][0].equals("----")){
           ...
           Map<String,waypointsAirway> wpts=airwaysList.get(temp1[1][0]).getWaypoints();
           if(wpts.containsKey(jTextField1.getText())){
            temp1[1][1]=jTextField1.getText(); 
             calcWpts(temp1[1][0],temp1[1][1]);
           }else{
            jTextField1.setText("Waypoint Entered Invalid"); 
...
//          temp1[1][1]=jTextField1.getText();
          ...
          displayRTE(); 
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectTransApprDep")){
              if(arrivalApprTransDep==null||arrivalApprTransDep.equals("")){
             arrivalApprTransDep=jLabel66.getText(); 
              }else{
               arrivalApprTransDep=""; 
              }
              displayApproaches();
             ...
             if(panelSelector.retrieveProperty("column2").equals("selectApprDep")){
              if(arrivalApprDep==null||arrivalApprDep.equals("")){
                arrivalApprDep=jLabel66.getText();
              }else{
//                arrivalApprTransDep=jLabel66.getText();
              }
displayApproaches();
              ...
              if(panelSelector.retrieveProperty("column2").equals("selectTransApprArr")){
              if(arrivalApprTransArr==null||arrivalApprTransArr.equals("")){
             arrivalApprTransArr=jLabel66.getText(); 
              }else{
               arrivalApprTransDep=""; 
              }
              displayApproaches();
             ...
             if(panelSelector.retrieveProperty("column2").equals("selectApprArr")){
              if(arrivalApproachArr==null||arrivalApproachArr.equals("")){
                arrivalApproachArr=jLabel66.getText();
              }else{
//                arrivalApprTransDep=jLabel66.getText();
              }
displayApproaches();
          ...
          temp1=rtePagesStore.get(activeRtePage);
           ...
           Map<String,waypointsAirway> wpts=airwaysList.get(temp1[2][0]).getWaypoints();
           if(wpts.containsKey(jTextField1.getText())){
            temp1[2][1]=jTextField1.getText(); 
              calcWpts(temp1[2][0],temp1[2][1]);
           }else{
            jTextField1.setText("Waypoint Entered Invalid"); 
          ...
          if(temp1[2][1].equals("----")==false){
           ...
           displayRTE();
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectTransApprDep")){
              if(arrivalApprTransDep==null||arrivalApprTransDep.equals("")){
             arrivalApprTransDep=jLabel68.getText(); 
              }else{
               arrivalApprTransDep=""; 
              }
              displayApproaches();
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectTransApprArr")){
              if(arrivalApprTransArr==null||arrivalApprTransArr.equals("")){
             arrivalApprTransArr=jLabel68.getText(); 
              }else{
               arrivalApprTransArr=""; 
              }
              displayApproaches();
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectApprDep")){
              if(arrivalApprDep==null||arrivalApprDep.equals("")){
                arrivalApprDep=jLabel68.getText();
              }else{
//                
//                arrivalApprTransDep=jLabel68.getText();
              }
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectApprArr")){
              if(arrivalApproachArr==null||arrivalApproachArr.equals("")){
                arrivalApproachArr=jLabel68.getText();
              }else{
//                
//                arrivalApprTransDep=jLabel68.getText();
              }
          ...
          if(temp1[3][0].equals("----")){
           ...
           Map<String,waypointsAirway> wpts=airwaysList.get(temp1[3][0]).getWaypoints();
           if(wpts.containsKey(jTextField1.getText())){
            temp1[3][1]=jTextField1.getText(); 
              calcWpts(temp1[3][0],temp1[3][1]);
           }else{
            jTextField1.setText("Waypoint Entered Invalid"); 
          ...
          if(temp1[3][1].equals("----")==false){
           ...
           displayRTE();
            ...
            case "Right5": if(state.equals("posinit")){panelSelector.writeProperty("irspos", text);jTextField1.setText("");}
             ...
             if(panelSelector.retrieveProperty("column2").equals("selectTransApprDep")){
              if(arrivalApprTransDep==null||arrivalApprTransDep.equals("")){
             arrivalApprTransDep=jLabel70.getText(); 
              }else{
               arrivalApprTransDep=""; 
              }
              displayApproaches();
            ...
            if(panelSelector.retrieveProperty("column2").equals("selectApprDep")){
              if(arrivalApprDep==null||arrivalApprDep.equals("")){
                arrivalApprDep=jLabel70.getText();
              }
              else{ 
//                arrivalApprTransDep=jLabel70.getText();
              }
          ...
          temp1=rtePagesStore.get(activeRtePage);
           ...
           Map<String,waypointsAirway> wpts=airwaysList.get(temp1[4][0]).getWaypoints();
           if(wpts.containsKey(jTextField1.getText())){
            temp1[4][1]=jTextField1.getText(); 
              calcWpts(temp1[4][0],temp1[4][1]);
           }else{
            jTextField1.setText("Waypoint Entered Invalid"); 
...
/*************
  * 
  * Method to show duplicate waypoints
  * REFER TO MANUAL PAGE 140 (FCOM)
  * ****************/


private void displayDuplicates(String text){
  Collection <Navaid> navList= navaids.get(text);
  Collection <Waypoints> wptsList=wpts.get(text);
  
  List<Navaid> navListF= new ArrayList<>();
  navListF.addAll(navList);
  List<Waypoints> wptsListF=new ArrayList<>();
  wptsListF.addAll(wptsList);
  
  List<String> wptsLatLong=new ArrayList<>();
  ...
  for(int i=0;i<wptsListF.size();i++){
    wptsLatLong.add(wptsListF.get(i).getLatitude());
  wptsLatLong.add(wptsListF.get(i).getLongitude());  
    
  }
  
  for(ListIterator<Navaid> iterate=navListF.listIterator();iterate.hasNext();){
  Frequencies.add(iterate.next().getFreq());
  ...
  for(int i=0;i<navListF.size();i++){
   wptType.add(navListF.get(i).getType()); 
    
  }
   for(int i=0;i<wptsListF.size();i++){
   wptType.add("WAYPOINT"); 
    
  }
   
  // System.out.println(text+ " : "+wptType.get(0)+" : "+wptsLatLong.get(0)+" : "+wptsLatLong.get(1));
   
   try{
     jLabel51.setText(text+"                  "+wptType.get(duplicateDisp));
     jLabel52.setText(Frequencies.get(duplicateDisp));
     jLabel61.setText("");
     jLabel62.setText(wptsLatLong.get(duplicateDisp)+" "+wptsLatLong.get(duplicateDisp+1));
    ...
    try{
     jLabel49.setText(text+"                  "+wptType.get(duplicateDisp+1));
     jLabel50.setText(Frequencies.get(duplicateDisp+1));
     jLabel63.setText("");
     jLabel64.setText(wptsLatLong.get(duplicateDisp+2)+" "+wptsLatLong.get(duplicateDisp+3));
   }catch(Exception e){e.printStackTrace();
     jLabel49.setText("");
     jLabel50.setText("");
     jLabel63.setText("");
   ...
   try{
     jLabel54.setText(text+"                  "+wptType.get(duplicateDisp+2));
     jLabel53.setText(Frequencies.get(duplicateDisp+2));
     jLabel65.setText("");
     jLabel66.setText(wptsLatLong.get(duplicateDisp+4)+" "+wptsLatLong.get(duplicateDisp+5));
   }catch(Exception e){e.printStackTrace();
   ...
   try{
     jLabel55.setText(text+"                  "+wptType.get(duplicateDisp+3));
     jLabel56.setText(Frequencies.get(duplicateDisp+3));
     jLabel67.setText("");
     jLabel68.setText(wptsLatLong.get(duplicateDisp+6)+" "+wptsLatLong.get(duplicateDisp+7));
   }catch(Exception e){e.printStackTrace();
    jLabel55.setText("");
     jLabel56.setText("");
     jLabel67.setText("");
   ...
   try{
     jLabel58.setText(text+"                  "+wptType.get(duplicateDisp+4));
     jLabel59.setText(Frequencies.get(duplicateDisp+4));
     jLabel69.setText("");
     jLabel70.setText(wptsLatLong.get(duplicateDisp+8)+" "+wptsLatLong.get(duplicateDisp+9));
   }catch(Exception e){e.printStackTrace();
   jLabel58.setText("");
     jLabel59.setText("");
     jLabel69.setText("");
...
// TODO add your handling code here:
 ...
 performAction("Right5",jTextField1.getText(),panelSelector.retrieveProperty("panelstate"));         // TODO add your handling code here:
    ...
    private void prevpageMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_prevpageMousePressed
      ...
      if(panelSelector.retrieveProperty("panelstate").equals("displaydup")){
       duplicateDisp+=5; 
    //    displayDuplicates("BAREE");
      }
...
if(panelSelector.retrieveProperty("column2").equals("selectApprDep")||panelSelector.retrieveProperty("column2").equals("selectApprArr")){
 listRun=0; 
...
if(panelSelector.retrieveProperty("panelstate").equals("stardep")){
 ...
 listTransStarDep=0;
  ...
  if(panelSelector.retrieveProperty("panelstate").equals("transSelectDepStar")||!(panelSelector.retrieveProperty("panelstate").equals("transSelectDepStar"))){
 if(listRun-5==listStarDep){
 listRun-=5;
 displayApproaches();
}
 }
...
if(panelSelector.retrieveProperty("panelstate").equals("transSelectDepStar")){
  listTransStarDep-=4;
 listRun-=5;
    if(listRun<0){
     listRun=0; 
...
if(panelSelector.retrieveProperty("column2").equals("selectTransApprDep")){
  if(listApprDepTrans<appr.get(key).getTrans().length){
 listApprDepTrans+=4;
 } 
  displayApproaches();
}
if(panelSelector.retrieveProperty("column2").equals("selectTransApprArr")){
  if(listApprDepTrans<apprArr.get(key).getTrans().length){
 listApprArrTrans+=4;
 } 
  displayApproaches();
}
  ...
  displayRTE();
    ...
    public void getATS(){
      Thread ats=new Thread(() ->{
        File file=new File(System.getProperty("user.dir")+"/MainApp.java");
        
        try(FileInputStream fis=new FileInputStream(file.getAbsoluteFile().getParent().substring(0,52)+"/navdata/navdata/airwaysFinal.ser"); ObjectInputStream ois=new ObjectInputStream(fis)){
    ...
    public void getNav(){
      ...
      Thread navaidsRetr=new Thread(() ->{
        File file=new File(System.getProperty("user.dir")+"/MainApp.java");
        
        try(FileInputStream fis=new FileInputStream(file.getAbsoluteFile().getParent().substring(0,52)+"/navdata/navdata/navaids.ser"); ObjectInputStream ois=new ObjectInputStream(fis)){
       ...
       System.out.println("NAVAIDS IMPORTED"); 
      });
    ...
    private void getDataStarsArr(){
      Thread pullData=new Thread(() ->  {
        rawStarsArr=accessLogic.getStars(panelSelector.retrieveProperty("dest"));
        for(int i=0;i<rawStarsArr.size();i++){
        starsTransition=accessLogic.getTransition(panelSelector.retrieveProperty("dest"),rawStarsArr.get(i));
        starsArr.put(rawStarsArr.get(i),new Stars(panelSelector.retrieveProperty("dest"),rawStarsArr.get(i),starsTransition));
        }
        
        apprArr=accessLogic.getApprRun(panelSelector.retrieveProperty("dest"));
      });
      pullData.start();
    }
    ...
    private void getDataStars(){
      ...
      Thread pullData=new Thread(() -> {
            ...
            for(int i=0;i<rawDataStars.size();i++){
              ...
              starsDep.put(rawDataStars.get(i),new Stars(panelSelector.retrieveProperty("origin"),rawDataStars.get(i),starsTransition));
            }
            
         appr=accessLogic.getApprRun(panelSelector.retrieveProperty("origin"));
//         System.out.println(appr);
//          System.out.println(appr==null);
        }
    ...
    public void retrieveWpts(){
     ...
     Thread waypoints=new Thread(() -> {
       ...
       try(FileInputStream fis=new FileInputStream(file.getAbsoluteFile().getParent().substring(0,52)+"/navdata/navdata/waypoints.ser"); ObjectInputStream ois=new ObjectInputStream(fis)){
         wpts=(LinkedListMultimap)ois.readObject();
       ...
       System.out.println("WAYPOINTS IMPORTED");
    ...
    /***************
      * 
      * METHOD TO DISPLAY APPROACHES AND APPRTR
      * 
      * *********************/
    
    public void displayApproaches(){
      
      if(buttonP==1){
      if(appr!=null){ 
        
        if(arrivalApprDep==null||arrivalApprDep==""){
          
          panelSelector.writeProperty("column2","selectApprDep");
       ...
       if(appr.size()<=5){
                    ...
                    jLabel63.setText("");
                    try{
                jLabel62.setText(appr.get(0).getIdent());
                    }catch(Exception e){jLabel62.setText("");}
                     try{
                jLabel64.setText(appr.get(1).getIdent());
                    }catch(Exception e){jLabel64.setText("");}
                try{
                jLabel66.setText(appr.get(2).getIdent());
                    }catch(Exception e){jLabel66.setText("");}      
                 try{
                jLabel68.setText(appr.get(3).getIdent());
                    }catch(Exception e){jLabel68.setText("");}
                  try{
                jLabel70.setText(appr.get(4).getIdent());
                    ...
                    jLabel63.setText("");
                     try{
                jLabel62.setText(appr.get(listRun).getIdent());
                     }catch(Exception e){jLabel62.setText((listRun<0 || listRun==0) ? appr.get(0).getIdent() : "" );}
                     try{
                jLabel64.setText(appr.get(listRun+1).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel64.setText("");}
                    catch(NullPointerException e){jLabel64.setText((listRun<0 || listRun==0) ? appr.get(1).getIdent() : "");}
                try{
                jLabel66.setText(appr.get(listRun+2).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel66.setText("");}  
                    catch(NullPointerException e){jLabel66.setText((listRun<0 || listRun==0) ? appr.get(2).getIdent() : "");}
                 try{
                jLabel68.setText(appr.get(listRun+3).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel68.setText("");}
                    catch(NullPointerException e){jLabel68.setText((listRun<0 || listRun==0) ? appr.get(3).getIdent() : "");}
                  try{
                jLabel70.setText(appr.get(listRun+4).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel70.setText("");}
                    catch(NullPointerException e){jLabel70.setText((listRun<0 || listRun==0) ? appr.get(4).getIdent() : "");}
                    
                    if(listRun<0 || listRun==0){
                    listRun=0;
                    }
                }
          ...
          if(arrivalApprTransDep.equals("")||arrivalApprTransDep==null){
            
          for (HashMap.Entry<Integer, Approaches> entry : appr.entrySet()) {
        if (entry.getValue().getIdent().equals(arrivalApprDep)) {
         key=entry.getKey();
         
        }
    }
          jLabel61.setText("APPROACHES");
          jLabel63.setText("TRANS");
         jLabel62.setText("<SEL>"+arrivalApprDep);
         if(appr.get(key).getTrans().length<=4){
           panelSelector.writeProperty("column2","selectTransApprDep");
           try{
          jLabel64.setText(appr.get(key).getTrans()[0]);
           }catch(Exception e){jLabel64.setText("");}
           try{
          jLabel66.setText(appr.get(key).getTrans()[1]);
           }catch(Exception e){jLabel66.setText("");}
           try{
          jLabel68.setText(appr.get(key).getTrans()[2]);
           }catch(Exception e){jLabel68.setText("");}
           try{
          jLabel70.setText(appr.get(key).getTrans()[3]);
           }catch(Exception e){jLabel70.setText("");}
         }else{
           try{
             panelSelector.writeProperty("column2","selectTransApprDep");
         jLabel64.setText(appr.get(key).getTrans()[listApprDepTrans+0]);
           }catch(Exception e){jLabel64.setText("");}
           try{
          jLabel66.setText(appr.get(key).getTrans()[listApprDepTrans+1]);
         }catch(Exception e){jLabel66.setText("");}
         try{
          jLabel68.setText(appr.get(key).getTrans()[listApprDepTrans+2]);
         }catch(Exception e){jLabel68.setText("");}
         try{
          jLabel70.setText(appr.get(key).getTrans()[listApprDepTrans+3]);
         }catch(Exception e){jLabel70.setText("");}
         }
          }else if(arrivalApprTransDep.equals("")==false||arrivalApprTransDep!=null){
            panelSelector.writeProperty("column2","selectTransApprDep");
              jLabel61.setText("APPROACHES");
          jLabel62.setText("<SEL>"+arrivalApprDep);
          jLabel63.setText("TRANS");
          jLabel64.setText("<SEL>"+arrivalApprTransDep);
          jLabel66.setText("");
          jLabel68.setText("");
          jLabel70.setText("");
        ...
        if(arrivalApproachArr==null||arrivalApproachArr==""){
       ...
       if(appr.size()<=5){
                    ...
                    jLabel63.setText("");
                    try{
                jLabel62.setText(apprArr.get(0).getIdent());
                    }catch(Exception e){jLabel62.setText("");}
                     try{
                jLabel64.setText(apprArr.get(1).getIdent());
                    }catch(Exception e){jLabel64.setText("");}
                try{
                jLabel66.setText(apprArr.get(2).getIdent());
                    }catch(Exception e){jLabel66.setText("");}      
                 try{
                jLabel68.setText(apprArr.get(3).getIdent());
                    }catch(Exception e){jLabel68.setText("");}
                  try{
                jLabel70.setText(apprArr.get(4).getIdent());
                    }catch(Exception e){jLabel70.setText("");}
                    ...
                    jLabel63.setText("");
                     try{
                jLabel62.setText(apprArr.get(listRun).getIdent());
                     }catch(Exception e){jLabel62.setText((listRun<0 || listRun==0) ? apprArr.get(0).getIdent() : "" );}
                     try{
                jLabel64.setText(apprArr.get(listRun+1).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel64.setText("");}
                    catch(NullPointerException e){jLabel64.setText((listRun<0 || listRun==0) ? apprArr.get(1).getIdent() : "");}
                try{
                jLabel66.setText(apprArr.get(listRun+2).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel66.setText("");}  
                    catch(NullPointerException e){jLabel66.setText((listRun<0 || listRun==0) ? apprArr.get(2).getIdent() : "");}
                 try{
                jLabel68.setText(apprArr.get(listRun+3).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel68.setText("");}
                    catch(NullPointerException e){jLabel68.setText((listRun<0 || listRun==0) ? apprArr.get(3).getIdent() : "");}
                  try{
                jLabel70.setText(apprArr.get(listRun+4).getIdent());
                    }catch(ArrayIndexOutOfBoundsException e){jLabel70.setText("");}
                    catch(NullPointerException e){jLabel70.setText((listRun<0 || listRun==0) ? apprArr.get(4).getIdent() : "");}
          ...
          if(arrivalApprTransArr.equals("")||arrivalApprTransArr==null){
            
          for (HashMap.Entry<Integer, Approaches> entry : apprArr.entrySet()) {
        if (entry.getValue().getIdent().equals(arrivalApproachArr)) {
         key=entry.getKey();
          ...
          jLabel61.setText("APPROACHES");
          jLabel63.setText("TRANS");
         jLabel62.setText("<SEL>"+arrivalApproachArr);
         if(apprArr.get(key).getTrans().length<=4){
           panelSelector.writeProperty("column2","selectTransApprArr");
           try{
          jLabel64.setText(apprArr.get(key).getTrans()[0]);
           }catch(Exception e){jLabel64.setText("");}
           try{
          jLabel66.setText(apprArr.get(key).getTrans()[1]);
           }catch(Exception e){jLabel66.setText("");}
           try{
          jLabel68.setText(apprArr.get(key).getTrans()[2]);
           }catch(Exception e){jLabel68.setText("");}
           try{
          jLabel70.setText(apprArr.get(key).getTrans()[3]);
           }catch(Exception e){jLabel70.setText("");}
         }else{
           try{
             panelSelector.writeProperty("column2","selectTransApprArr");
         jLabel64.setText(apprArr.get(key).getTrans()[listApprArrTrans+0]);
           }catch(Exception e){jLabel64.setText("");}
           try{
          jLabel66.setText(apprArr.get(key).getTrans()[listApprArrTrans+1]);
         }catch(Exception e){jLabel66.setText("");}
         try{
          jLabel68.setText(apprArr.get(key).getTrans()[listApprArrTrans+2]);
         }catch(Exception e){jLabel68.setText("");}
         try{
          jLabel70.setText(apprArr.get(key).getTrans()[listApprArrTrans+3]);
         }catch(Exception e){jLabel70.setText("");}
         }
          }else if(arrivalApprTransDep.equals("")==false||arrivalApprTransDep!=null){
            panelSelector.writeProperty("column2","selectTransApprArr");
          ...
          jLabel62.setText("<SEL>"+arrivalApproachArr);
          jLabel63.setText("TRANS");
          jLabel64.setText("<SEL>"+arrivalApprTransArr);
          jLabel66.setText("");
          jLabel68.setText("");
          jLabel70.setText("");
  ...
  public void displayStarsandRunways(){
      ...
      if(rawDataStars.size()<=5){
          ...
          }catch(IndexOutOfBoundsException e){  jLabel52.setText("");}
   ...
   jLabel51.setText("STARS");
           jLabel52.setText(starSelectedDep+"<SEL>");   
              ...
              try{
                   ...
                   text=starsDep.get(starSelectedDep).getTrans().get(listTransStarDep);
              jLabel50.setText(text);
              }catch(IndexOutOfBoundsException e){ jLabel50.setText("");}
              try{
                   text=starsDep.get(starSelectedDep).getTrans().get(listTransStarDep+1);
               jLabel53.setText(text);
              }catch(IndexOutOfBoundsException e){jLabel53.setText("");}
              try{
                    text=starsDep.get(starSelectedDep).getTrans().get(listTransStarDep+2);
                jLabel56.setText(starsDep.get(starSelectedDep).getTrans().get(listTransStarDep+2));
              }catch(IndexOutOfBoundsException e){jLabel56.setText("");}
              try{
                   text=starsDep.get(starSelectedDep).getTrans().get(listTransStarDep+3);
                 jLabel59.setText(text);
              }catch(IndexOutOfBoundsException e){jLabel59.setText("");}
          }
              }else{
               jLabel50.setText(arrivalTransDep+"<SEL>"); 
                jLabel53.setText("");
                jLabel56.setText("");
                jLabel59.setText("");
              }
      ...
      try{
       ...
       try{
        ...
        if(starSelectedArr==null||starSelectedArr.equals("")){
          ...
          jLabel52.setText(rawStarsArr.get(listStarArr));
          }catch(IndexOutOfBoundsException e){  jLabel52.setText("");}
          
           try{
              jLabel49.setText("");
          jLabel50.setText(rawStarsArr.get(listStarArr+1));
          }catch(IndexOutOfBoundsException e){jLabel49.setText(""); jLabel50.setText("");}
           
            try{
              jLabel54.setText("");
          jLabel53.setText(rawStarsArr.get(listStarArr+2));
          }catch(IndexOutOfBoundsException e){jLabel54.setText(""); jLabel53.setText("");}
          
      
      try{
              jLabel55.setText("");
          jLabel56.setText(rawStarsArr.get(listStarArr+3));
          }catch(IndexOutOfBoundsException e){jLabel55.setText(""); jLabel56.setText("");}
       try{
              jLabel58.setText("");
          jLabel59.setText(rawStarsArr.get(listStarArr+4));
          }catch(IndexOutOfBoundsException e){jLabel58.setText(""); jLabel59.setText("");}
        }else{
...
/////////////////////////////////////////////////////////////////////////////////////////
  ...
  /***********
    * 
    * METHOD TO GET WPTS FOR AIRWAYS AND ADD DIRECT WPTS/NAVAIDS
    * 
    * ***************/
...
//   }
 ...
 //System.out.println(sidsDep.get("LAKES3").getRunways());
      });
      sidPull.start();
...
/*else if(currentText.charAt(length-1)=='+'){
 ...
 clicked=0;
    ...
    public void intializePanel(){
      panelSelector.writeProperty("column2", "null");
