...
/*  public static void main(String []args){
   ...
   File file=new File(System.getProperty("user.dir")+"/WaypoimtAccess.java");
...
public double calcBearing (double req_lat, double req_lon, double req_lat2, double req_lon2){
 ...
 return nd_hdg;
    ...
    String icao=file.getAbsoluteFile().getParent().substring(0,52)+"/navdata/navdata/Airports.txt";
    String line="";
   ...
   //Gets the latitude and longitude of SID waypoints. Gets the lat and long for transition selected if there is one. 
        ...
        String trans=z;
        boolean takeInput=false;
        icao=file.getAbsoluteFile().getParent().substring(0,52)+"/navdata/navdata/PROC/"+icao+".txt";
     ...
     //     System.out.println();
      ...
      //    System.out.println(Waypoints);
          ...
          String directory=file.getAbsoluteFile().getParent().substring(0,52)+"/navdata/navdata/Airports.txt";
          try{
